  ...
  <div class="body">
    ...
    <div class="main bscroll dr-content" ref="bscroll">
      ...
      <div class="dr-content-item">
        ...
        <div class="dr-item">
          <div class="dr-item-order">3</div>
          <div class="dr-item-title">安全行车、文明驾驶基础知识</div>
          <div class="dr-item-num">
            <span>0</span>题 >
          </div>
        </div>
        <div class="dr-item">
          <div class="dr-item-order">4</div>
          <div class="dr-item-title">机动车驾驶操作相关基础知识</div>
          <div class="dr-item-num">
            <span>0</span>题 >
          </div>
        </div>
      ...
      <div class="dr-tip">
        <font>答对一次将移除此做题记录</font> <font>更改设置</font>
      </div>
    </div>
  </div>
</template>
